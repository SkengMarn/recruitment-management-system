-- Add missing columns to agents table for agency principals and users array
-- This script can be run directly on both local and remote databases

-- Add principal details to agents table
ALTER TABLE public.agents
  ADD COLUMN IF NOT EXISTS principal_name text NOT NULL DEFAULT 'N/A',
  ADD COLUMN IF NOT EXISTS principal_contact text NOT NULL DEFAULT 'N/A';
...
CREATE INDEX IF NOT EXISTS idx_agents_users ON public.agents USING GIN (users);
